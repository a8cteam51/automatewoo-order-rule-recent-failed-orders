...
/**
 * Class Failed_Orders_In_Previous_Twenty_Four
 */
class Failed_Orders_Previous_Twenty_Four extends Abstract_Number {
	...
	public function init() {
		$this->title = __( 'Shop - Failed Orders in Previous 24 Hours', 'automatewoo' );
		$this->group = __( 'Shop', 'automatewoo' );
	}

	/**
	 * Validates the rule against the number of failed orders in the store for the last 24 hours.
	 *
...
return new Failed_Orders_Previous_Twenty_Four();
