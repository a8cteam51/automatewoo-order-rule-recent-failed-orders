...
/**
 * Class Failed_Orders_In_Previous_Twelve
 */
class Failed_Orders_Previous_Twelve extends Abstract_Number {
	...
	public function init() {
		$this->title = __( 'Shop - Failed Orders in Previous 12 Hours', 'automatewoo' );
		$this->group = __( 'Shop', 'automatewoo' );
	}

	/**
	 * Validates the rule against the number of failed orders in the store for the last 12 hours.
	 *
...
return new Failed_Orders_Previous_Twelve();
